export default function HeroHome() {
  return (
    <section>
      <div className="min-h-screen flex justify-center items-center mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="pb-12 text-center md:pb-20">
            <h1
              ...
              data-aos="fade-up"
            >
              Syna improves your <br></br>Discord experience
            </h1>
            <div className="mx-auto max-w-4xl">
              <p
                ...
                data-aos-delay={200}
              >
                A multipurpose all-in-one bot, enhancing 
                your experience with user-focused commands.
              </p>
